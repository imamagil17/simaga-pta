...
<body class="h-full antialiased text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-900" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="px-6 py-5 bg-emerald-900/80 border-b border-emerald-800/80 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="font-bold text-base tracking-wide text-white">SIMAGA PTA</h1>
                        <p class="text-xs text-emerald-300 font-medium">PTA Palu</p>
                    </div>
                </div>
            ...
            <div class="px-6 py-3 bg-emerald-900/40 border-b border-emerald-800/40">
                <div class="text-xs text-emerald-300 font-medium">Masuk Sebagai:</div>
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-1.5 scrollbar-thin scrollbar-thumb-emerald-800">
                @if(Auth::user()->isAdministrator())
                    ...
                    <div class="pt-3 pb-1 px-3 text-[11px] font-bold text-amber-400/90 uppercase tracking-wider">Data Magang</div>
                    
                    @foreach(['Mahasiswa', 'Mentor', 'Instansi', 'Periode Magang', 'Penempatan'] as $item)
                        <div class="flex items-center justify-between px-3 py-2 rounded-lg text-sm text-emerald-300/60 bg-emerald-900/20 cursor-not-allowed select-none">
                            ...
                            <span class="text-[10px] px-1.5 py-0.5 rounded bg-emerald-900/60 text-emerald-400 font-medium">Segera</span>
                        </div>
                    @endforeach

                    <div class="pt-3 pb-1 px-3 text-[11px] font-bold text-amber-400/90 uppercase tracking-wider">Monitoring</div>
                    ...
                    <div class="pt-3 pb-1 px-3 text-[11px] font-bold text-amber-400/90 uppercase tracking-wider">Lainnya</div>
                ...
                @elseif(Auth::user()->isMentor())
                    ...
                    <div class="pt-3 pb-1 px-3 text-[11px] font-bold text-amber-400/90 uppercase tracking-wider">Bimbingan & Evaluasi</div>
                ...
                @elseif(Auth::user()->isMahasiswa())
                    ...
                    <div class="pt-3 pb-1 px-3 text-[11px] font-bold text-amber-400/90 uppercase tracking-wider">Aktivitas Magang</div>
                ...
                <div class="pt-3 pb-1 px-3 text-[11px] font-bold text-amber-400/90 uppercase tracking-wider">Pengguna</div>
            ...
            <div class="p-4 border-t border-emerald-800/80 bg-emerald-900/40">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold bg-emerald-900 hover:bg-rose-900/80 text-emerald-100 hover:text-white border border-emerald-700 hover:border-rose-700 transition-all duration-200 shadow-sm">
            ...
            <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700/60 shadow-sm sticky top-0 z-30">
                <div class="px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        <button @click="sidebarOpen = true" class="md:hidden p-2 rounded-lg text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Pengadilan Tinggi Agama Palu</p>
                        </div>
                    </div>
