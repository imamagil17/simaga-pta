<x-simaga-layout>
    ...
    <x-slot:title>Monitoring Logbook - SIMAGA PTA</x-slot:title>
    <x-slot:headerTitle>Monitoring Logbook</x-slot:headerTitle>
    ...
    <div class="mx-auto max-w-7xl space-y-6">
        ...
        <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Pantau seluruh aktivitas logbook mahasiswa yang sedang menjalani magang.
                </p>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="mb-5">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Gunakan filter untuk mempersempit data logbook.
                </p>
            ...
            <form
                method="GET"
                action="{{ route('admin.logbook.index') }}"
                ...
                <div class="flex flex-wrap gap-3 md:col-span-2 lg:col-span-4">
                    ...
                    <button
                        type="submit"
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-800">
                        Filter
                    </button>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="flex flex-col gap-2 border-b border-gray-200 px-6 py-5 dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Menampilkan {{ $logbooks->count() }} data.
                    </p>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-700/30">
                            ...
                            <td class="px-5 py-4">
                                ...
                                <p class="max-w-sm font-semibold text-gray-900 dark:text-gray-100">
                            ...
                            <td class="px-5 py-4 text-right">
                                ...
                                <a
                                    href="{{ route('admin.logbook.show', $logbook) }}"
