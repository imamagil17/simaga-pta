<x-simaga-layout>
    <x-slot:title>Edit Profil Mahasiswa - SIMAGA PTA</x-slot:title>
    <x-slot:headerTitle>Edit Profil Mahasiswa</x-slot:headerTitle>
    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <form
            method="POST"
            action="{{ route('admin.mahasiswa.profile.update', $user) }}"
        ...
        >
            ...
            {{-- Akademik --}}
            <div class="space-y-5 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="Laki-laki" @selected(old('jenis_kelamin', $mahasiswa->jenis_kelamin) === 'Laki-laki')}>
                                Laki-laki
                            </option>
                            <option value="Perempuan" @selected(old('jenis_kelamin', $mahasiswa->jenis_kelamin) === 'Perempuan')}>
                                Perempuan
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach([
                                ...
                                <option
                                    value="{{ $agama }}"
                                    @selected(old('agama', $mahasiswa->agama) === $agama)
                                >
                                    {{ $agama }}
                                </option>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="block w-full rounded-xl border border-gray-300 bg-white text-sm text-gray-700 file:mr-4 file:border-0 file:bg-emerald-50 file:px-4 file:py-3 file:font-medium file:text-emerald-700 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300"
                        >
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="w-full rounded-xl border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                        >
                            <option value="active" @selected(old('status', $mahasiswa->status) === 'active')}>
                                Aktif
                            </option>

                            <option value="inactive" @selected(old('status', $mahasiswa->status) === 'inactive')}>
                                Tidak Aktif
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="3"
                            class="w-full rounded-xl border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                        >{{ old('keterangan', $mahasiswa->keterangan) }}</textarea>
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                <button
                    type="submit"
                    class="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800"
                >
