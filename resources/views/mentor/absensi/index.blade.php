<x-simaga-layout>
    <x-slot:title>Absensi Mahasiswa - SIMAGA PTA</x-slot:title>
    <x-slot:headerTitle>Absensi Mahasiswa</x-slot:headerTitle>
        ...
        <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">
                    Absensi Mahasiswa Bimbingan
                </h3>

                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Periksa dan verifikasi absensi mahasiswa yang menjadi tanggung jawab Anda.
                </p>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-4 py-2 text-sm font-semibold text-gray-700 dark:border-gray-700 dark:bg-gray-900/40 dark:text-gray-300">
                    Total {{ $absensis->count() }}
                </span>

                @if ($pendingCount > 0)

                <span class="inline-flex items-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-semibold text-amber-700 dark:border-amber-900/40 dark:bg-amber-900/20 dark:text-amber-300">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-700/30">
                            ...
                            <td class="px-5 py-4 text-right">
                                ...
                                <a href="{{ route('mentor.absensi.show', $absensi->id) }}"
                                    class="inline-flex items-center gap-1.5 rounded-lg bg-gray-100 px-3 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-200 hover:text-gray-900 dark:bg-gray-700/40 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-gray-100">
                                    <svg
                                        class="h-4 w-4"
                                        fill="none"
                                        stroke="currentColor"
